    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <div className="bg-white border-b border-slate-200 py-12">
        <div className="container mx-auto max-w-7xl px-4 md:px-8">
          <h1 className="text-4xl font-bold text-navy-950 tracking-tight mb-4">Meine Ausschreibungen</h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed">Verwalten Sie Ihre aktiven, abgeschlossenen und als Entwurf gespeicherten Ausschreibungen.</p>
        </div>
      </div>
